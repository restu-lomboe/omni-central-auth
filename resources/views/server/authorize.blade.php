            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="px-8 py-6">
                    ...
                    <div class="text-center mb-6">
                        <div class="inline-flex items-center justify-center w-14 h-14 bg-gray-100 rounded-2xl border border-gray-200 mb-3">
                    ...
                    <div class="bg-gray-50 rounded-xl border border-gray-200 px-4 py-3 mb-6 flex items-center gap-3">
                        <div class="w-9 h-9 rounded-full bg-omni-500 flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
